...
рассматриваемых постов. Возвращает отсортированный список моментов времени в формате Unix.
            - `get_mutual_friends` Метод, возвращающий всех общих друзей по переданным ссылкам на профили
            - `get_common_connections` Метод, возвращающий список общих друзей для каждого друга переданного пользователя в виде [({Ваш друг}, [{общий друг}, {еще один общий друг}]),({Ваша подруга}, None)]...
