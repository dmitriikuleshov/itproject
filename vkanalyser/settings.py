"""
Django settings for vkanalyser project.
...
SECRET_KEY = 'django-insecure-*6mwcb3to+@)j4d7un!ph3qm6!la88nf00#9n)k-@@9%8r)n1$'
...
WSGI_APPLICATION = 'vkanalyser.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'vkanalyser/static')
]
